...
>(({ className, children, ...props }, ref) => {
  ...
  const positionStyle: React.CSSProperties = offset
    ? { left: offset.x, top: offset.y, translate: '-50% -50%' }
    : {}
    ...
    <AlertDialogPortal>
      ...
      >
        ...
        <button
          ...
          className="absolute left-4 top-4 rounded-sm opacity-40 ring-offset-background transition-opacity hover:opacity-70 focus:outline-none cursor-grab active:cursor-grabbing z-10"
          title="Drag to move"
        >
