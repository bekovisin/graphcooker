      ...
      >
        ...
        {settings.bars.emptyRowLine.show && categories.map((_, ci) => {
          ...
          return (
            <line
              key={`empty-line-${ci}`}
              x1={padding.left + emptyRowPaddingH}
              y1={lineY}
              x2={padding.left + plotWidth - emptyRowPaddingH}
              y2={lineY}
        ...
        {categories.map((cat, ci) => {
          ...
          series.forEach((s, si) => {
            ...
            if (settings.labels.showDataPointLabels && rawValue !== 0) {
              ...
              // pushes it past its own bar. Use a 1px edge pad for the value "1" only.
              const edgePad = labelText === '1' ? 1 : 4;
              if (labelPos === 'left') {
